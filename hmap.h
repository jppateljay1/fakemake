...
//to keep track of any repeated files
HMAP_PTR global_repeat;
...
*/
extern void * hmap_set(HMAP_PTR map, char *key, void *val, int dep);
...
//extern void hmap_free(HMAP_PTR map); 
